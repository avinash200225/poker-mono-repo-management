...
export const GameSettings = () => {
  ...
  const handleOnSubmit = (values, actions) => {
    console.log({
      ...
      rakePercent: values.tournamentMode ? 0 : +values.rakePercent,
      blind: values.blind,
    });
              ...
              <GridItem pt="2" bg="#F6FBF9" area={"main"} zIndex="2">
                ...
                >
                  ...
                  <Flex w={"100%"} justifyContent={"flex-start"}>
                    {/* <FormControl w={'50%'} border={'1px solid #DEF'} padding={'4'}>
                    <FormLabel htmlFor="pokerVariant"><Text color="blue.500" fontSize="4xl">Poker Variant</Text></FormLabel>
                    <RadioGroup id="pokerVariant" name="pokerVariant" onChange={props.handleChange('pokerVariant')} value={props.values.pokerVariant}>
                      <HStack spacing={8} direction="row">
                        <Radio size='lg' colorScheme='blue' value="Texas"><Text fontSize="3xl">Texas</Text></Radio>
                        <Radio size='lg' colorScheme='blue' value="Omaha"><Text fontSize="3xl">Omaha</Text></Radio>
                        <Radio size='lg' colorScheme='blue' value="Pinapple" isDisabled><Text fontSize="3xl">Pinapple</Text></Radio>
                      </HStack>
                    </RadioGroup>
                  </FormControl>
                  <Spacer /> */}
                    ...
                    >
                      ...
                      <Switch
                        size={"lg"}
                        id="liveDealer"
                        isChecked={props.values.liveDealer}
                        onChange={props.handleChange("liveDealer")}
                      />
                      {props.values.liveDealer ? (
                        <Text color="blue.500" fontSize="4xl">
                          ON
                        </Text>
                      ) : (
                  ...
                  <FormControl>
                    <FormLabel htmlFor="betLimit"><Text color="blue.500" fontSize="4xl">Bet Limit</Text></FormLabel>
                    <RadioGroup id="betLimit" name="betLimit" onChange={props.handleChange('betLimit')} value={props.values.betLimit}>
                      <HStack spacing={8} direction="row">
                        <Radio size='lg' colorScheme='blue' value="Limit"><Text fontSize="3xl">Fixed Limit</Text></Radio>
                        <Radio size='lg' colorScheme='blue' value="Pot Limit"><Text fontSize="3xl">Pot Limit</Text></Radio>
                        <Radio size='lg' colorScheme='blue' value="No Limit"><Text fontSize="3xl">No Limit</Text></Radio>
                      </HStack>
                    </RadioGroup>
                  </FormControl>
                </Flex> */}
                  ...
                  <Flex width={"100%"} padding={"4"}>
                    <FormControl as={HStack} w={"50%"}>
                      <FormLabel htmlFor="tournamentMode">
                        <Text color="blue.500" fontSize="4xl">
                          Tournament Mode:{" "}
                        </Text>{" "}
                      </FormLabel>
                      <Switch
                        size={"lg"}
                        id="tournamentMode"
                        isChecked={props.values.tournamentMode}
                        onChange={props.handleChange("tournamentMode")}
                      />
                      {props.values.tournamentMode ? (
                        <Text color="blue.500" fontSize="4xl">
                          ON
                        </Text>
                      ) : (
                    ...
                    {!props.values.tournamentMode && (
                      <FormControl w={"50%"}>
                        <FormLabel pb={8} htmlFor="rakePercent">
                          <Text color={"blue.500"} fontSize="4xl">
                            {" "}
                            Rake Percentage
                          </Text>
                        ...
                        <Slider
                          ...
                          onChange={(e) =>
                            props.setFieldValue("rakePercent", e)
                          }
                        >
                ...
                <Flex width={'100%'} padding={'4'}  >
                <FormControl>
                  <FormLabel pb={8} htmlFor="blind"><Text color={'blue.500'}  fontSize="4xl">Min Bet/ Big Blind</Text></FormLabel>

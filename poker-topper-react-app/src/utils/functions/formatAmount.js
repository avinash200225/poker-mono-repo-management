...
export function formatAmount(amount, amountType, formatConfig, currencyCode, showCurrencySymbol, // used to override the configuration attribute
showCurrencyCode // used to override the configuration attribute
  ...
  var showSymbol = typeof showCurrencySymbol !== 'undefined' ? showCurrencySymbol : formatConfig.showCurrencySymbol;
  var showCode = typeof showCurrencyCode !== 'undefined' ? showCurrencyCode : formatConfig.showCurrencyCode;

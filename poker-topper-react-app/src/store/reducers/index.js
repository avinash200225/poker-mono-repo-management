...
export const usersAccountsHistoryReducer = (state=usersAccountsHistoryInitialState, action) => {
    // //console.log(action.type)
    // //console.log(action.data)
...
export const usersMoneyTransactionsHistoryReducer = (state=usersMoneyTransactionsHistoryInitialState, action) => {
    switch (action.type){
...
export const gamesActivityHistoryReducer = (state=gamesActivityHistoryInitialState, action) => {
    switch (action.type){
